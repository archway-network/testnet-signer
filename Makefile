...
HTTPS_GIT := https://github.com/archway-network/augusta-testnet-signer.git
...
ifeq ($(OS),Windows_NT)
	...
	go build -mod=readonly $(BUILD_FLAGS) -o build/augusta-testnet-signer .
endif
...
draw-deps:
	...
	@goviz -i ./cmd/augusta-testnet-signer -d 2 | dot -Tpng -o dependency-graph.png
...
build-docker:
	docker build . -t augusta-testnet-signer:latest
